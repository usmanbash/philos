...
const _isMobile = () => {
  let _is = REGEX_MOBILE_OR_TABLET1.test(navigator.userAgent) || REGEX_MOBILE_OR_TABLET2.test(navigator.userAgent.slice(0, 4))

  // another try for ipad air
  if (!_is) {
    _is = navigator.userAgent.match(/Mac/) && navigator.maxTouchPoints && navigator.maxTouchPoints > 2
  }
